<div class="container-fluid">
            ...
            <!-- end page title -->
            <form  accept-charset="UTF-8" action="<?=base_url()?>addArtShopPost" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="product-title-input" name="title"
                                        placeholder="Enter Art title" required>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                                ...
                                <div class="hstack gap-3 align-items-start">
                                    <div class="flex-grow-1">
                                        <input class="form-control" data-choices data-choices-multiple-remove="true"
                                            placeholder="Enter tags" type="text" name="tags"/>
                                    </div>
                                </div>
                            </div>
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="hstack gap-3 align-items-start">
                                    <div class="flex-grow-1">
                                        <input class="form-control" name="size" data-choices data-choices-multiple-remove="true"
