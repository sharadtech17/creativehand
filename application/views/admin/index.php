			...
			<div id="scrollbar">
				<div class="container-fluid">
					...
					<ul class="navbar-nav" id="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link menu-link <?= ($title === 'Subscripition List' || $title === 'Subscription History') ? 'active' : ''; ?>" href="#subscriptionpackage" data-bs-toggle="collapse" role="button"
							...
							<div class="collapse menu-dropdown <?= ($title === 'Subscripition List' || $title === 'Subscription History') ? 'show' : ''; ?>" id="subscriptionpackage">
								<ul class="nav nav-sm flex-column">
									<li class="nav-item">
										<a href="<?=base_url()?>administrator/subscriptionhistory" class="nav-link <?= ($title === 'Subscription History') ? 'active' : ''; ?>" data-key="t-horizontal">Subscription History</a>
									</li>
									<li class="nav-item">
										<a href="<?=base_url()?>administrator/subscriptionList" class="nav-link <?= ($title === 'Subscripition List') ? 'active' : ''; ?>" data-key="t-horizontal">Subscripition package List</a>
									</li>
