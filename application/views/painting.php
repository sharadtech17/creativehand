	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-xs-12">
			...
			<div class="col-sm-9 col-md-9 col-xs-12">
				<div style="margin-bottom: 40px;" class="single-varients-product gallery_product 
					col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
					<a href="Painting detail.html">
						<img src="assets/images/product/product-7.jpg" class="img-responsive"></a>
					...
					<div class="row">
						...
						<h6 class="col-md-3 text-center" style="font-size: smaller; display: flex;">
						...
						<h6 class="col-md-5">Catagary1</h6>
						<!-- <h6>Artist</h6> -->
				...
				<div style="margin-bottom: 40px;"
					class="single-varients-product gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
					<a href="Painting detail.html">
						<img src="assets/images/product/product-6.jpg" class="img-responsive"></a>
				...
				<div style="margin-bottom: 40px;"
					class="single-varients-product gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
					<a href="Painting detail.html">
						<img src="assets/images/product/product-5.jpg" class="img-responsive"></a>
