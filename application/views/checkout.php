            ...
            <div class="row">
                ...
                <div class="col-lg-7 px-5 py-4">
                    ...
                    <form class="mb-5">
                        <div class="row">
                            <div class="col-md-6 mb-5">
                                <div class="form-outline">
                                    ...
                                    <input type="Fast Name" id="typeExp" class="form-control form-control-lg"
                                        value="Fast Name" size="7" id="exp" minlength="7" maxlength="7" />
                                </div>
                            </div>
                            <div class="col-md-6 mb-5">
                                <div class="form-outline">
                                    ...
                                    <input type="Last Name" id="typeText" value="Last Name"
                        ...
                        <div class="form-outline mb-5">
                            <label class="form-label" for="typeText">Company name
                                (optional)</label>
                        ...
                        <div class="form-outline mb-5">
                            ...
                            <select type="text" id="typeText" class="form-control form-control-lg" siez="17"
                            ...
                            <div class="col-md-12 mb-5">
                                <div class="form-outline">
                                    ...
                                    <input type="text" id="typeExp" class="form-control form-control-lg"
                                        value="patelDhruvi8801@gmail.com" size="7" id="exp" minlength="7"
                                        maxlength="7" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-5 px-5 py-4">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="flex-grow-1 ms-3 row">
                            <h5 class="col-lg-6">Detox-Tea × 1</h5>
                    ...
                    <div class="d-flex justify-content-between p-2 mb-2 row" style="">
                        ...
                        <h5 class="fw-bold mb-0 col-lg-6 text-right">₹95.00</h5>
                    </div>
                    ...
                    <div class="d-flex justify-content-between p-2 mb-2 row" style="">
                        ...
                        <h5 class="fw-bold mb-0 col-lg-6 text-right">₹135.00</h5>
                    </div>
                    <div class="d-flex justify-content-between p-2 mb-2 row" style="">
                    ...
                    <div class="margin-top-20 margin-bottom-20 text-center">
                        <span class="input-group-btn">
                            ...
                            btn-primary btn-lg text-capitalize margin-bottom-30">place Oder</a>
                        </span>
                    </div>
                </div>
            </div>
