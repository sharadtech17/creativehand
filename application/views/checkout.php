    ...
    style="background: linear-gradient(#070606b3, rgba(30, 23, 23, 0)) ,url(<?= base_url() ?>assets/images/banner/home-banner-big.jpg); ">
        <div class="container-fluid padding-fix">
            ...
            <ul class="list-inline text-center" style="padding-top: 100px; padding-bottom: 100px;">
                <h1 class="" style="color:white;">Checkout</h1>
                <li><a href="<?= base_url() ?>" style="font-size: larger;color: white;">Home <i
                            class="fa fa-angle-right"></i></a>
                </li>
                <li class="" style="color:#c66b15;">Checkout</li>
            </ul>
        </div>
    </div>
</section>
...
<main class="product-page">
    ...
    <section class="h-100 h-custom">
        <div class="container h-100 py-5">
            <form  accept-charset="UTF-8" action="<?=base_url()?>order/place" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-7 px-5 py-4">
                        <h3 class="mb-5 pt-2 text-center fw-bold text-uppercase">Billing details
                        </h3>
                            <div class="row">
                                <div class="col-md-6 mb-5">
                                    <div class="form-outline">
                                        ...
                                        <input type="text" id="typeExp" name="f_name" class="form-control form-control-lg"
                                            value="" size="7" id="exp" minlength="7" maxlength="7" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-5">
                                    <div class="form-outline">
                                        <label class="form-label" for="typeText">Last Name</label>
                                        <input type="text" id="typeText" value="" name="l_name"
                            ...
                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeText">Company name (optional)</label>
                                <input type="text" id="typeText" class="form-control form-control-lg" name="company" />
                            </div>


                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeText">Country / Region</label>
                                <select name="country" id="typeText" class="form-control form-control-lg" siez="17"
                            ...
                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeText">Street address</label>

                                <input type="text" id="typeText" class="form-control form-control-lg" name="address" />
                            </div>
                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeText">Town / City</label>
                                <input type="text" id="typeText" class="form-control form-control-lg" name="city" />
                            </div>
                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeText">State </label>
                                <select type="text" id="typeText" class="form-control form-control-lg" name="state">
                            ...
                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeName">PIN Code</label>
                                <input type="text" id="typeName" class="form-control form-control-lg" name="pincode" />
                            </div>
                            <div class="form-outline mb-5">
                                <label class="form-label" for="typeName">Phone </label>

                                <input type="number" id="typeName" class="form-control form-control-lg" name="phone" />
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-5">
                                    <div class="form-outline">
                                        <label class="form-label" for="typeExp">Email address</label>
                                        <input type="text" id="typeExp" class="form-control form-control-lg" name="email" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row margin-bottom-40">
                                <div class="col-md-12 mb-5">
                                    <div class="form-outline">
                                        <label class="form-label" for="typeExp">Order notes
                                            (optional)</label>
                    ...
                    <div class="col-lg-5 px-5 py-4">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <?php $subtotal=0; if($cartlist): ?>
                                <?php foreach ($cartlist as $cart): ?>
                                    <div class="flex-grow-1 ms-3 row">
                                        <h5 class="col-lg-6"><?= $cart->title ?></h5>
                                        <h5 class=" col-lg-6 text-right">₹<?= $cart->total_amount ?></h5>
                                    </div>
                                    <?php
                        ...
                        <div class="d-flex justify-content-between p-2 mb-2 row" style="">
                            <h5 class="fw-bold mb-0 col-lg-6">Subtotal:</h5>
                        ...
                        <div class="d-flex justify-content-between p-2 mb-2 row" style="">
                            ...
                            <h5 class="fw-bold mb-0 col-lg-6 text-right">₹<?= $subtotal ?></h5>
                            <input type="hidden" id="typeExp" class="form-control form-control-lg" name="total_amount" value="<?= $subtotal ?>" />
                        </div>
                        <div class="d-flex justify-content-between p-2 mb-2 row" style="">
                            <h5 class="fw-bold mb-0 col-lg-6"><a href="">
                                    <input type="checkbox" name="" id="">
                                </a> Pay Online</h5>
                        </div>
                        <p>Pay by Credit / Debit card / Internet Banking through CCAvenue Secure
                            Servers.</p>
                        <hr class="mb-4" style="height: 2px; background-color: black; opacity: 1;">
                        <p>Your personal data will be used to process your order, support your
                            experience throughout this website, and for other purposes described in
                            our privacy policy.</p>
                        <h5 class="fw-bold mb-0 col-lg-12"><a href="">
                                <input type="checkbox" name="" id="">
                            </a> I have read and agree to the website <a href="Terms-and_Conditions.html"> terms and
                                conditions </a>*
                        </h5>
                        <div class="margin-top-20 margin-bottom-20 text-center">
                            <span class="input-group-btn">
                                <button type="submit" class="product-cart-con btn
                                btn-primary btn-lg text-capitalize margin-bottom-30">place Oder</button>
                            </span>
                        </div>
                    </div>
                </div>
