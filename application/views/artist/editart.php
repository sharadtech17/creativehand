<div class="container-fluid">
	...
	<!-- end page title -->
	<form id="editartform" method="POST" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="text-center">
								<div class="position-relative d-inline-block">
									<div class="position-absolute top-100 start-100 translate-middle">
										...
										<input class="form-control d-none" value="" name="mainimage"
...
<script>
	...
	$(document).ready(function () {
		$('#editartform').submit(function (e) {
			...
			if (validateForm()) {
				$.ajax({
					url: '<?= base_url('ArtistController/updateart') ?>',
					type: 'post',
					data: formData,
					dataType: 'json',
					contentType: false,
					...
					success: function (response) {
						if (response.success) {
							alert('Arts Updated Successfully..');
