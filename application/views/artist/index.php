...
if (isset($this->session->userdata['creativehandsartist'])) {
	...
	$artistname = $this->db->select('name')->get_where('artist', ['id' => $artistid])->row('name');
	$artistprofileimage = $this->db->select('profileimage')->get_where('artist', ['id' => $artistid])->row('profileimage');
}else{
	redirect (base_url());
	die();
}
				...
				<div class="navbar-header">
					<div class="d-flex">
						...
						<div class="navbar-brand-box horizontal-logo">
							<a href="<?=base_url()?>artist-panel/dashboard" class="logo logo-dark">
								<span class="logo-sm">
							...
							<a href="<?=base_url()?>artist-panel/dashboard" class="logo logo-light">
								<span class="logo-sm">
									<img src="<?=base_url()?>artistassets/images/logo-sm.png" alt="" height="22">
								</span>
								<span class="logo-lg">
						...
						<div class="dropdown ms-sm-3 header-item topbar-user">
							<button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="d-flex align-items-center">
									<img class="rounded-circle header-profile-user" src="<?=base_url().$artistprofileimage?>" onerror="this.onerror=null; this.src='<?=base_url()?>artistassets/altuser.jpg'" alt="Header Avatar">
									<span class="text-start ms-xl-2">
										<span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?=$artistname?></span>
										<span
										class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Artist</span>
									</span>
								</span>
							</button>
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a class="dropdown-item" href="<?=base_url()?>artist-panel/view-profile"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i><span class="align-middle">Profile</span></a>
								<a class="dropdown-item" href="<?=base_url()?>artist-panel/edit-profile"><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Settings</span></a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="<?=base_url()?>artistlogout"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div id="scrollbar">
				<div class="container-fluid">
					...
					<ul class="navbar-nav" id="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link menu-link <?= ($title === 'Dashboard') ? 'active' : ''; ?>" href="<?=base_url()?>artist-panel/dashboard">
								<i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Dashboard</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link menu-link <?= ($title === 'View Profile' || $title ==='Edit Profile') ? 'active' : ''; ?>" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
								<i class="ri-apps-2-line"></i> <span data-key="t-apps">Profile</span>
							</a>
							<div class="collapse menu-dropdown <?= ($title === 'View Profile' || $title ==='Edit Profile') ? 'show' : ''; ?>" id="sidebarApps">
								<ul class="nav nav-sm flex-column">
									<li class="nav-item">
										<a href="<?=base_url()?>artist-panel/view-profile" class="nav-link <?= ($title === 'View Profile') ? 'active' : ''; ?>" data-key="t-calendar">
											View Profile
										</a>
									</li>
									<li class="nav-item">
										<a href="<?=base_url()?>artist-panel/edit-profile" class="nav-link <?= ($title ==='Edit Profile') ? 'active' : ''; ?>" data-key="t-chat"> Edit Profile</a>
									</li>
								</ul>
							</div>
						</li>
						<li class="nav-item">
							<a class="nav-link menu-link <?= ($title === 'View All Arts' || $title ==='Add Art') ? 'active' : ''; ?>" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
								<i class="ri-layout-3-line"></i> <span data-key="t-layouts">My Arts</span>
							</a>
							<div class="collapse menu-dropdown <?= ($title === 'View All Arts' || $title ==='Add Art') ? 'show' : ''; ?>" id="sidebarLayouts">
								<ul class="nav nav-sm flex-column">
									<li class="nav-item">
										<a href="<?=base_url()?>artist-panel/view-all-arts" class="nav-link <?= ($title === 'View All Arts') ? 'active' : ''; ?>" data-key="t-horizontal">View All Arts</a>
									</li>
									<li class="nav-item">
										<a href="<?=base_url()?>artist-panel/add-art" class="nav-link  <?= ($title === 'Add Art') ? 'active' : ''; ?>" data-key="t-detached">Add Art</a>
									</li>
								</ul>
							</div>
						</li>
						<!-- <li class="nav-item">
							...
							<div class="collapse menu-dropdown <?= ($title === 'My Subscription' || $title ==='Subscription History') ? 'show' : ''; ?>" id="sidebarLayouts1">
								<ul class="nav nav-sm flex-column">
									<li class="nav-item">
										<a href="<?=base_url()?>artist-panel/my-subscription" class="nav-link <?= ($title === 'My Subscription') ? 'active' : ''; ?>" data-key="t-horizontal">My
										Subscription</a>
									</li>
									<li class="nav-item">
										<a href="<?=base_url()?>artist-panel/subscription-history" class="nav-link <?= ($title === 'Subscription History') ? 'active' : ''; ?>" data-key="t-detached">Subscription History
										</a>
									</li>
