...
<main class="collection-page">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <ul class="list-inline pagination margin-clear li-list">
                                <?php echo $pagination_links; ?> <!-- Pagination links generated by CodeIgniter -->
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            // Find all <a> tags within the pagination container and wrap them with <li> tags
            $('.li-list a').wrap('<li style="margin:3px;"></li>');
            $('.li-list strong').wrap('<li><a></a></li>');
        });
    </script>
</main>